 ...
 * @since       11.1
 */
class JFormRuleEquals extends RokCommon_Form_AbstractValidator
{
	/**
	...
	public function test(&$element, $value, $group = null, &$input = null, &$form = null)
	{
		...
		// Check that a valid RokCommon_Form object is given for retrieving the validation field value.
