...
/**
 * RokCommon_Form's helper class.
 * Provides a storage for filesystem's paths where RokCommon_Form's entities reside and methods for creating those entities.
...
class RokCommon_Form_Helper
{
	...
	/**
	 * Static array of RokCommon_Form's entity objects for re-use.
	...
	/**
	 * Attempt to import the RokCommon_Form_AbstractField class file if it isn't already imported.
	 * You can use this method outside of RokCommon_Form for loading a field for inheritance or composition.
	 *
	...
	/**
	 * Attempt to import the RokCommon_Form_AbstractValidator class file if it isn't already imported.
	 * You can use this method outside of RokCommon_Form for loading a rule for inheritance or composition.
	 *
